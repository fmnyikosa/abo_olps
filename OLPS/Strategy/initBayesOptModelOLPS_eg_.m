...
function model = initBayesOptModelOLPS_eg_()
...
settings.hyp_lb            = log([ 000.1, 0.020, 0.01, 0.00001 ]); % 00.1, 0.009, 1.00, 
settings.hyp_ub            = log([ 500.0, 0.080, 2.00, 0.10000 ]); % 10.0, 0.900, 1.00, 
