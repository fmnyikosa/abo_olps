...
function model = initBayesOptModelOLPS_olmar_()

% We assume that data is 3D - {time, param1, param2}
...
% %                                   l1   l2  l3    sf1   l1    l2  l3    sf2   sn
% settings.hyp_lb           = log([ 00.1, 10, 0.15, 1.00, 00.1, 10, 0.15, 0.01, 0.0001 ]);
% settings.hyp_ub           = log([ 10.0, 15, 0.85, 1.00, 10.0, 15, 0.85, 2.00, 0.0100 ]);

%                                   l1      l2   sf1   l1     l2    sf2   sn
settings.hyp_lb            = log([ 0000.1, 0.0, 0.01, 0.0001 ]); % 00.1, 0.15, 1.00, 
settings.hyp_ub            = log([ 1500.0, 1.0, 3.00, 0.1000 ]); % 10.0, 0.85, 1.00,
