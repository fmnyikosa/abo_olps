...
function model = initBayesOptModelOLPS_cwmr_()
...
settings.hyp_lb            = log([ 0001, 0.1, 0.01, 0.00001 ]); % 000.1, 0.4, 1.00, 
settings.hyp_ub            = log([ 1200, 0.9, 3.00, 0.10000 ]); % 100.0, 0.6, 1.00, 
