...
function model = initBayesOptModelOLPS_ons_()
...
settings.hyp_lb            = log([ 00.1, 0.01, 0.01, 0.00001 ]); % 00.1, 0.001, 1.00, 
settings.hyp_ub            = log([ 10.0, 0.09, 2.00, 0.1000 ]); % 10.0, 0.100, 1.00, 
